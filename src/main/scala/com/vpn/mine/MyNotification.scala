...
import com.vpn.mine.aidl.IShadowsocksServiceCallback.Stub
import com.vpn.mine.utils.{Action, State, TrafficMonitor, Utils}
import com.vpn.mine.MyApplication.app
import com.vpn.mine.activity.MainActivity
/**
  * Created by coder on 17-7-14.
  */
class MyNotification(private val service: BaseService, profileName: String, visible: Boolean = false) {
